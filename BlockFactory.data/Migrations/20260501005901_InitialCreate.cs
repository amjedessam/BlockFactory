    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElectronicWallets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentUnitCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ElectronicWalletName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_ElectronicWallets_WalletId",
                        column: x => x.WalletId,
                        principalTable: "ElectronicWallets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RawMaterialTransactions_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlySalaries_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PledgeTypeOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pledges_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pledges_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductionFormulas_RawMaterials_RawMaterialId",
                        column: x => x.RawMaterialId,
                        principalTable: "RawMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityNet = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Advances_MonthlySalaries_MonthlySalaryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deductions_MonthlySalaries_MonthlySalaryId",
                        column: x => x.MonthlySalaryId,
                        principalTable: "MonthlySalaries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Deductions_Workers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Workers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionMaterialUsages_ProductionRecords_ProductionRecordId",
                        column: x => x.ProductionRecordId,
                        principalTable: "ProductionRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductionMaterialUsages_RawMaterials_RawMaterialId",
                        column: x => x.RawMaterialId,
                        principalTable: "RawMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advances_MonthlySalaryId",
                table: "Advances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deductions_MonthlySalaryId",
                table: "Deductions",
                column: "MonthlySalaryId");

            migrationBuilder.CreateIndex(
                name: "IX_Deductions_WorkerId",
                table: "Deductions",
                column: "WorkerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlySalaries_WorkerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pledges_CustomerId",
                table: "Pledges",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Pledges_OrderId",
                table: "Pledges",
                column: "OrderId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionFormulas_RawMaterialId",
                table: "ProductionFormulas",
                column: "RawMaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionMaterialUsages_ProductionRecordId",
                table: "ProductionMaterialUsages",
                column: "ProductionRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionMaterialUsages_RawMaterialId",
                table: "ProductionMaterialUsages",
                column: "RawMaterialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawMaterialTransactions_SupplierId",
                table: "RawMaterialTransactions",
                column: "SupplierId");
