...
namespace BlockFactory.Data
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IRepository<Reservation> Reservations
            => new Repository<Reservation>(_context);
        public IRepository<ReservationItem> ReservationItems
            => new Repository<ReservationItem>(_context);
        public IRepository<PriceSnapshot> PriceSnapshots
            => new Repository<PriceSnapshot>(_context);
        public IRepository<WithdrawalTransaction> WithdrawalTransactions
            => new Repository<WithdrawalTransaction>(_context);
        public IRepository<WithdrawalItem> WithdrawalItems
            => new Repository<WithdrawalItem>(_context);
